...
| Ranker reconstruido sobre el ALS original (revertido) | v3 | 🔄 **pendiente de confirmar en Kaggle** | CV local: +3.4% sobre su base (consistente con el +3.9% que dio sobre la base tuneada). Hipótesis razonada, no confirmada: si el uplift real en Kaggle es similar al +7.1% ya visto, podría superar el 0.03864. Submission generada, falta subirla. |
