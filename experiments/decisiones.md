...
| Seguir tuneando LightGBM / agregando features al ranker | v3 | 🔄 **repensar el criterio, no necesariamente pausar** | La razón original para pausar (el ranker "empeora" sobre ALS fuerte) no está confirmada -- es ruido. Si se retoma, decidir con validación cruzada local (mucho menor error estándar por tener ~10x más usuarios) en vez de esperar una sola submission de Kaggle para desempatar mejoras chicas. |
