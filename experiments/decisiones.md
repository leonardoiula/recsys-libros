...
| Hiperparámetros `factors=128, regularization=0.1, iterations=20` | v2 | ✅ **resuelto — re-confirmados** | Re-sweepeados bajo el split corregido (n_val=1 temporal): siguen siendo un buen punto, 192 factors o más iteraciones dan <5% de mejora a cambio de más tiempo de entrenamiento. Se mantienen. |
