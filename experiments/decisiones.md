...
| Agregar features de autor/año de edición/diversidad de género/recencia al ranker | v3 | ✅ **conservar -- mejora grande y consistente** | +9.4% de NDCG local sobre el ranker sin ellas, positivo en los 3 seeds individualmente -- la mejora más sólida de la sesión. Ver `bitacora.md`, sección "Se retoma el ranker". Pendiente confirmar en Kaggle, pero es del tamaño que justifica gastar una submission real. |
