...
## Candidatos de autores ya leídos (4ª fuente — ver `legacy/modelo_actual.md`, sección "Recomendación: ¿cambiar de paradigma?")
...
## Candidatos por similitud de resumen (5ª fuente — ver `legacy/modelo_actual.md`, sección "Recomendación: ¿cambiar de paradigma?")
...
## Candidatos por co-lectura ítem-ítem (6ª fuente — ver `legacy/decisiones.md`)
...
## Género macro (10 familias de dominio — ver `legacy/decisiones.md` sección 7)
...
## Editorial (tamaño de catálogo — ver `legacy/decisiones.md` sección 8)
...
## Señales cruzadas lector↔libro (ronda 2026-08-31 — ver `legacy/decisiones.md` sección 11)
...
feature del ranker (ver también `legacy/decisiones.md`, sección "EDA: qué se
usó y qué no"):
...
- `vive_en` (ubicación del lector) — **se probó y se descartó** como
  ...
  seeds (ver `legacy/decisiones.md` sección 9 y `legacy/bitacora.md`). `pais_por_usuario`/
...
- Franja de nacimiento del lector — **se probó y se descartó** como
  ...
  (ver `legacy/decisiones.md` sección 10 y `legacy/bitacora.md`). De paso se corrigió
